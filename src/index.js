...
let cssVars = {
    ...
    'html': {
        '--motion-default-timing': 'var(--motion-default-timing)',
        '--motion-bounce': 'var(--motion-bounce)',
        '--motion-spring-smooth': 'var(--motion-spring-smooth)',
        '--motion-spring-snappy': 'var(--motion-spring-snappy)',
        '--motion-spring-bouncy': 'var(--motion-spring-bouncy)',
        '--motion-spring-bouncier': 'var(--motion-spring-bouncier)',
        '--motion-spring-bounciest': 'var(--motion-spring-bounciest)',
    }
}
const convertCSSVarsToCSS = (cssVars) => {
    const cssLines = []
    
    for (const [selector, properties] of Object.entries(cssVars)) {
        cssLines.push(selector + ' {')
            for (const [property, value] of Object.entries(properties)) cssLines.push('  ' + property + ': ' + value + ';')
        cssLines.push('}')
...
export default defineConfig({
    ...
    preflights: [
        {
            getCSS: () => convertCSSVarsToCSS(cssVars)
        }
    ],
    variants: [
