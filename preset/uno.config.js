...
export default defineConfig({
    ...
    rules: [
        ...
        [/^motion-scale-in(-(.+))?$/, ([, , size = 'DEFAULT'], { theme }) => {
    ...
    preflights: [
        {
            ...
            getCSS: () => {
                ...
                // Add for backdrop (let's skip for smaller var size, maybe revisit later)...
                // css.push(convertCSSVarsToCSS('::backdrop', cssVars))

                // Reduced motion, just kills the animation completely...
                css.push(`
